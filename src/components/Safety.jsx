      ...
      <div className="container-px relative">
        ...
        <div className="relative mx-auto mt-14 max-w-5xl">
          ...
          <div aria-hidden className="absolute left-1/2 top-1/2 z-10 hidden -translate-x-1/2 -translate-y-1/2 lg:block">
            <span className="flex h-12 w-12 items-center justify-center rounded-full border border-white/15 bg-bg2 text-xs font-bold uppercase tracking-[0.15em] text-muted shadow-card">
              vs
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            {/* Them */}
            <Reveal>
              <div className="relative h-full overflow-hidden rounded-3xl border border-danger/25 bg-gradient-to-br from-danger/[0.07] via-white/[0.02] to-transparent p-7 shadow-card backdrop-blur-sm sm:p-8">
            ...
            {/* Coldcast */}
            <Reveal delay={0.1}>
              <div className="relative h-full overflow-hidden rounded-3xl border border-safe/30 bg-gradient-to-br from-safe/[0.09] via-white/[0.02] to-transparent p-7 shadow-glow-safe backdrop-blur-sm ring-1 ring-safe/10 sm:p-8">
