...
export const PRODUCT_PAGES = {
  ...
  'apollo-scraper': {
    ...
    comparison: {
      heading: 'How Coldcast compares to other Apollo scrapers.',
      rows: [
        { label: 'Data freshness', them: 'Stale cache', us: 'Real-time re-verified' },
        { label: 'Export limits', them: 'Page-by-page caps', us: 'Whole list, no cap' },
    ...
    hero: {
      ...
      subtitle:
        'The account-safe Apollo.io scraper and email extractor. Export any Apollo people or company search to CSV in minutes — no page-by-page export limits and no burning export credits — then Coldcast re-verifies every contact in real time and fills the gaps with waterfall enrichment, at 3x lower cost than Apollo credits or general scrapers like Apify.',
      badges: ['No export credits', 'People + company search', 'Real-time verified', '3x cheaper'],
    },
    how: {
      heading: 'Any Apollo search to a clean list — fast.',
      subtitle: 'No page-by-page limits, no stale credits, no ban risk.',
      steps: [
        { emoji: '🧩', title: 'Install the extension', desc: 'One-click Chrome extension connects your Apollo account — the extraction itself runs in a secure cloud browser.' },
        { emoji: '🔗', title: 'Open your Apollo search', desc: 'Build any Apollo people search or company (organization) search — filters, keywords, saved lists.' },
        { emoji: '📋', title: 'Start the export', desc: 'Pull the entire list at once — not 25 rows at a time, and without spending Apollo export credits.' },
        { emoji: '💧', title: 'Waterfall re-enrichment', desc: 'Every contact is re-enriched and re-verified live as it exports, filling gaps Apollo leaves.' },
        { emoji: '✅', title: 'Catch-alls cleaned', desc: 'Risky catch-all addresses are tested and filtered out before they hit your list.' },
        { emoji: '⬇️', title: 'Export or sync', desc: 'Download a clean CSV/XLSX or push straight to your CRM and sequencer.' },
      ],
    },
    features: {
      heading: 'The account-safe Apollo scraper, built for volume.',
      subtitle: 'Everything Apollo gives you — re-checked, topped up, and exported without the credit meter.',
      items: [
        ...
        { emoji: '💧', title: 'Waterfall enrichment', desc: 'Fills the gaps Apollo leaves with verified emails and direct dials from multiple providers.' },
        { emoji: '✅', title: 'Catch-all verification', desc: 'Every risky address is tested before it reaches your list, so bounces stay low.' },
        { emoji: '🛡️', title: 'Account-safe extraction', desc: 'Human-paced, cloud-run extraction that keeps your Apollo account off the ban radar.' },
        { emoji: '📤', title: 'Whole-list export', desc: 'No page limits and no export caps — the full search, in one download.' },
        { emoji: '🔌', title: 'CRM & outbound sync', desc: 'Send clean rows straight to HubSpot, Salesforce, Instantly, Smartlead or Lemlist.' },
        { emoji: '💸', title: '3x cheaper than credits', desc: 'A fraction of per-credit pricing for the same — cleaner — data.' },
      ],
    },
    stats: [
    ...
    benefits: {
      ...
      items: [
        ...
        { emoji: '🎯', title: 'Send-ready', desc: 'Catch-all cleaning and 99% validity mean fewer bounces and a protected sender reputation.' },
        { emoji: '🎟️', title: 'No credit anxiety', desc: 'Stop rationing Apollo export credits — pull the whole search and only pay for verified results.' },
        { emoji: '🛡️', title: 'Account-safe by design', desc: 'Human-paced, cloud-based extraction, so your Apollo account isn’t the one taking the risk.' },
        { emoji: '🧩', title: 'One pipeline, not four tools', desc: 'Scrape, enrich and verify in one place instead of stitching an exporter to a separate verifier.' },
        { emoji: '💸', title: 'Three times cheaper', desc: 'More usable contacts for a fraction of the per-credit cost.' },
      ],
    },
    faq: [
      ...
      { q: 'How do I scrape Apollo without using export credits?', a: 'Coldcast reads the contacts your Apollo search already displays and exports them directly to CSV, so you don’t spend a per-row Apollo export credit. You keep Apollo for search and filtering; Coldcast handles the export, verification and enrichment.' },
      { q: 'What is the Apollo export limit, and how do I get past it?', a: 'Apollo caps exports page-by-page and by monthly credit allowance. Coldcast pulls the entire Apollo search at once — no per-page caps — and re-verifies every contact live as it exports.' },
      ...
      { q: 'Is there an Apollo scraper Chrome extension?', a: 'Yes — Coldcast connects through a one-click Chrome extension, but the extraction runs in a secure cloud browser at human pace, so you get extension convenience without the ban risk of a scraper that hammers Apollo from your local tab.' },
      { q: 'Is scraping Apollo.io safe — will it get my account banned?', a: 'It can if you use a reckless, max-speed scraper. Coldcast paces extraction like a human and runs it in the cloud, so account safety is enforced by default rather than left to you to configure.' },
      ...
      { q: 'Coldcast vs Apify for scraping Apollo — which is better?', a: 'Apify is a general-purpose scraping platform you configure and maintain yourself; Coldcast is purpose-built for Apollo and LinkedIn lead export with verification and waterfall enrichment baked in. For lead generation specifically, Coldcast gives you campaign-ready lists without maintaining actors or proxies.' },
      { q: 'Do you clean catch-all emails?', a: 'Yes — catch-alls are tested and the risky ones removed before you send, so your bounce rate stays low.' },
      { q: 'How do I export Apollo leads to CSV?', a: 'Open your Apollo search, start the Coldcast export, and download a clean CSV or XLSX — re-verified in real time and catch-all cleaned, ready for your CRM or sequencer.' },
    ],
    cta: {
      title: 'Export Apollo — fresh, clean and cheaper.',
      subtitle: 'Pull any people or company search, re-verified in real time, for a third of the price — no export credits.',
    },
  },
